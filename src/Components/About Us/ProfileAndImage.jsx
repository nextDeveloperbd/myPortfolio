        ...
        <div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-2 items-center min-h-[90vh]'>
                <div className='space-y-2 md:space-y-4 md:col-span-2'>
                    ...
                    <p className='md:pb-4'><span className='font-bold'>Orbitshiftbd</span> is a performance-focused web development and digital marketing company committed to assisting businesses in growing online. We are experts in creating high-performance websites and implementing strategic marketing campaigns that generate traffic, engagement, and conversions. Whether you require a stylish website, SEO optimization, or social media growth, we provide solutions that make a difference. Let's grow your business to the next level! <Link to='/blogs' className='text-blue-600'>blog</Link>, <Link to='/portfolio' className='text-blue-600'>project portfolio</Link>.</p>
                    <div className="flex gap-2 ">
                        <Link href="/portfolio" className="px-5 py-4 rounded-full relative group overflow-hidden font-medium bg-[#1a3c3d]  text-white inline-block ">
                        ...
                        <Link href="'/services" className="px-5 py-4 rounded-full relative group overflow-hidden font-medium bg-gray-800 text-white inline-block ">
                            <span className="btnPortfolio"></span>
                            <span className="relative group-hover:text-white flex items-center md:gap-2"><FaLocationArrow className='hidden md:block'/>View Services</span>
                        </Link>
                    </div>
                </div>
